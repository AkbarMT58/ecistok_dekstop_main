...
const BannerCariProduct = ({ pages, classNameLayout }) => {
  ...
  return (
    <div
      className={` ${classNameLayout} bg-gray-100 relative rounded-md h-auto space-y-10 flex flex-col justify-between p-10 items-start`}
    >
      <div className='w-2/3'>
        ...
        <button
          ...
          className='text-white font-semibold mt-2 text-2xl shadow-md bg-orange-500 py-4 px-10 hover:bg-orange-400'
        >
          Cari Produk
        </button>
      </div>
...
export default BannerCariProduct;
